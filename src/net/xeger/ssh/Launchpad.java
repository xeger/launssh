...
public class Launchpad
{
	...
	static final private String[] LAUNCHERS = {
		"net.xeger.ssh.launchers.osx.Applescript",
		"net.xeger.ssh.launchers.unix.GnomeTerminal",
		"net.xeger.ssh.launchers.unix.Konsole",
		"net.xeger.ssh.launchers.unix.Xterm",
		"net.xeger.ssh.launchers.windows.PuTTY",
		"net.xeger.ssh.launchers.windows.OpenSSH",
		"net.xeger.ssh.launchers.windows.GenericSSH"
	};
